...
function recordAsyncExpect(_test2, promise, assertion, error) {
  ...
  if (test5 && promise instanceof Promise) {
    ...
    test5.onFinished.push(() => {
      var _a2;
      if (!resolved) {
        const processor = ((_a2 = globalThis.__vitest_worker__) == null ? void 0 : _a2.onFilterStackTrace) || ((s) => s || "");
...
function wrapAssertion(utils, name, fn2) {
  return function(...args) {
    ...
    try {
      ...
      (_a2 = test5.result).errors || (_a2.errors = []);
    ...
    formatted = formatted.replace(
      ...
      (_, key) => {
        ...
        return objDisplay(objectAttr(items[0], key), {
          truncate: (_b = (_a2 = runner == null ? void 0 : runner.config) == null ? void 0 : _a2.chaiConfig) == null ? void 0 : _b.truncateThreshold
        });
      }
    );
  }
...
${JSON.stringify(
      ...
      stack = ((_b = (_a2 = this.environment).processStackTrace) == null ? void 0 : _b.call(_a2, _stack)) || _stack;
      stack.column--;
...
// src/use-cases/testes/register-user.test.ts
var import_bcryptjs2 = require("bcryptjs");
var userRepository;
var userUserCase;
describe("Teste para o registro de usu\xE1rio", () => {
  beforeEach(() => {
    userRepository = new InMemoryUserRepository();
    userUserCase = new RegisterUser(userRepository);
  });
  test3("Deve ser poss\xEDvel criar um novo usu\xE1rio.", async () => {
    ...
    globalExpect(user.email).toEqual("fulano@gmail.com");
  });
  test3("N\xE3o deve ser poss\xEDvel criar um usu\xE1rio com um e-mail ja cadastrado.", async () => {
  ...
  test3("Deve ser poss\xEDvel que a senha esteja criptografada.", async () => {
    const { user } = await userUserCase.execute({
      email: "fulano@gmail.com",
      name: "fulano",
      password: "123456"
    });
    const passwordIsHashed = await (0, import_bcryptjs2.compare)("123456", user.password_hash);
    globalExpect(passwordIsHashed).toEqual(true);
  });
});
