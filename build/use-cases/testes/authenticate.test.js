...
// src/use-cases/testes/authenticate.test.ts
var import_bcryptjs2 = require("bcryptjs");
var userRepository;
var authenticateUserCase;
describe("Teste para a autentica\xE7\xE3o de usu\xE1rios", () => {
  beforeEach(() => {
    userRepository = new InMemoryUserRepository();
    authenticateUserCase = new Authenticate(userRepository);
  });
  test3("Deve ser poss\xEDvel autenticar um usu\xE1rio.", async () => {
  ...
  test3("N\xE3o deve ser poss\xEDvel se autenticar com um e-mail incorreto.", async () => {
    await globalExpect(
  ...
  test3("N\xE3o deve ser poss\xEDvel se autenticar com uma senha incorreta.", async () => {
    await userRepository.create({
      email: "fulano@gmail.com",
      name: "Fulano",
      password_hash: await (0, import_bcryptjs2.hash)("123456", 6)
