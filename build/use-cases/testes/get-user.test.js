...
// src/use-cases/testes/get-user.test.ts
...
var userRepository;
var getUserUseCase;
describe("Teste para resgatar usu\xE1rios.", () => {
  beforeEach(() => {
    userRepository = new InMemoryUserRepository();
    getUserUseCase = new GetUser(userRepository);
  });
  test3("Deve ser poss\xEDvel resgatar um usu\xE1rio pelo ID.", async () => {
  ...
  test3("N\xE3o deve ser poss\xEDvel resgatar um usu\xE1rio com um ID inv\xE1lido.", async () => {
    const createdUser = await userRepository.create({
      email: "fulano@gmail.com",
      name: "Fulano",
      password_hash: await (0, import_bcryptjs.hash)("123456", 6)
